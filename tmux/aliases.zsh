...
alias cldyo='export CLAUDE_CODE_EXPERIMENTAL_AGENT_TEAMS=1 && claude agents --dangerously-skip-permissions --model opus'
alias cce='cldyo --plugin-dir ~/code/compound-engineering-plugin/plugins/compound-engineering'
